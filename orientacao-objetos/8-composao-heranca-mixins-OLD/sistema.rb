...
algoritmos = Livro.new('Programacao O O em Ruby', 70, 2000, true, true, 'Globo')

#
# livro_arquitetura_software = Livro.new('Arquitetura de software', 70, 2000, true, true, 'Globo2')
#
